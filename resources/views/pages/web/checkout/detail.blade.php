                    ...
                    <form action="#">
                            ...
                            <ul class="nav nav-pills nav-justified custom-nav" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link fs-15 p-3 active" id="pills-finish-tab" data-bs-toggle="pill"
                                        ...
                                        aria-selected="true" data-position="3"><i
                        ...
                        <div class="tab-content">
                            <div class="text-center py-5">
                                ...
                                <h5>Terima kasih! Pesanan Anda telah dibuat.</h5>
                                <p class="text-muted">Anda akan mendapatkan notifikasi konfirmasi segera setelah kami
                                ...
                                <a href="{{ route('web.checkout.pdf', $order->id) }}"
                                    class="btn btn-sm btn-primary me-2 fs-6  " target="_blank" class="menu-link px-3">Cetak
                                    Laporan Pesanan</a>
                            </div>
                        </div>
                    </form>
